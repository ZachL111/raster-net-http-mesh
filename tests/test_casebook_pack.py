"""Regression checks for the raster-net-http-mesh casebook."""
...
from casebook.harness import assert_expected, raster_net_http_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(raster_net_http_mesh_summary(), assert_expected())
