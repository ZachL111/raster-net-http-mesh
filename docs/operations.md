...
`raster-net-http-mesh` is centered on networking work in TypeScript. The technical target is: Design a TypeScript verification harness for http systems, covering security rule linting, safe and unsafe fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 167. Risk has a penalty of 5, latency has a penalty of 3, and weight contributes a bonus of 2.
